...
EmergencyBrakeSystem::EmergencyBrakeSystem(
...
void EmergencyBrakeSystem::print_name() const
{
...
void LaneKeepingAssist::print_name() const
{
    std::cout << "Lane Keeping Assist\n";
}
...
void AdaptiveCruiseControl::print_name() const
{
